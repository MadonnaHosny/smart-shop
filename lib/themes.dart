...
ThemeData lightTheme = ThemeData(
    ...
    colorScheme: const ColorScheme(
        ...
        onSecondary: Color.fromRGBO(55, 55, 55, 1),
        error: Color.fromRGBO(117, 117, 117, 1),
        onError: Color.fromRGBO(117, 117, 117, 1),
        background: Color.fromRGBO(117, 117, 117, 1),
        onBackground: Color.fromRGBO(224, 224, 224, 1),
        surface: Color.fromRGBO(117, 117, 117, 1),
        onSurface: Color.fromRGBO(117, 117, 117, 1),
        primaryContainer: Colors.black,
        onPrimaryContainer: Color.fromRGBO(224, 224, 224, 1),
        onSecondaryContainer: Color.fromARGB(40, 198, 48, 48),
        outline: Colors.white,
        secondaryContainer: Colors.white),
    indicatorColor: Colors.deepPurple,
    floatingActionButtonTheme: const FloatingActionButtonThemeData(
        backgroundColor: Color.fromRGBO(198, 48, 48, 1),
...
ThemeData darkTheme = ThemeData(
    ...
    appBarTheme:
        const AppBarTheme(backgroundColor: Color.fromARGB(221, 37, 35, 35)),
    colorScheme: const ColorScheme(
        brightness: Brightness.dark,
        primary: Color.fromARGB(221, 37, 35, 35),
        onPrimary: Color.fromRGBO(66, 66, 66, 1),
        secondary: Color.fromARGB(5, 0, 0, 0),
        ...
        onSecondaryContainer: Color.fromARGB(219, 198, 48, 48),
        outline: Colors.black54,
        secondaryContainer: Color.fromRGBO(48, 48, 48, 1)),
